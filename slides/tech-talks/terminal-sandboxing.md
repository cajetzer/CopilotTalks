...
<div class="mt-4 relative z-10">
<span class="px-6 py-2 bg-gradient-to-r from-cyan-600/80 to-blue-600/80 rounded-full text-white text-lg font-medium shadow-lg shadow-cyan-500/25">Terminal Sandboxing: Safe Agentic Execution</span>
</div>
...
<div class="text-cyan-400 font-bold text-lg">🌐 Network Isolated</div>
<div class="opacity-80 text-xs">100% exfiltration prevented</div>
</div>
<div class="p-3 bg-gradient-to-br from-blue-900/30 to-blue-800/20 rounded-lg border border-blue-500/30">
<div class="text-blue-400 font-bold text-lg">📁 Credentials Safe</div>
<div class="opacity-80 text-xs">Home directory blocked</div>
</div>
<div class="p-3 bg-gradient-to-br from-indigo-900/30 to-indigo-800/20 rounded-lg border border-indigo-500/30">
<div class="text-indigo-400 font-bold text-lg">✅ Fully Auditable</div>
<div class="opacity-80 text-xs">Complete diagnostics</div>
</div>
</div>
<div class="mt-6 text-sm opacity-60 relative z-10">Enable sandbox, run agents safely, and monitor with diagnostics</div>

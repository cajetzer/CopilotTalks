...
<h1 class="!text-5xl !font-bold !mt-8 bg-gradient-to-r from-cyan-400 via-blue-400 to-indigo-400 bg-clip-text text-transparent relative z-10">Copilot Chat Internals</h1>
<div class="mt-4 relative z-10">
<span class="px-6 py-2 bg-gradient-to-r from-cyan-600/80 to-blue-600/80 rounded-full text-white text-xl font-medium shadow-lg shadow-cyan-500/25">Debugging AI Interactions</span>
</div>
<div class="mt-8 text-lg opacity-70 relative z-10">Transform AI debugging from guesswork into systematic investigation</div>
...
<div class="font-semibold text-red-300">Black Box Frustration</div>
<div class="text-xs opacity-80 mt-1">No visibility into what the model received</div>
</div>
<div class="p-4 bg-gradient-to-br from-orange-900/30 to-orange-800/30 rounded-lg border border-orange-500/30">
<div class="text-xl mb-2">❓</div>
<div class="font-semibold text-orange-300">Context Mystery</div>
<div class="text-xs opacity-80 mt-1">Which files? Instructions loaded? Tools failed?</div>
</div>
<div class="p-4 bg-gradient-to-br from-amber-900/30 to-amber-800/30 rounded-lg border border-amber-500/30">
<div class="text-xl mb-2">🔁</div>
<div class="font-semibold text-amber-300">Trial-and-Error Cycle</div>
<div class="text-xs opacity-80 mt-1">20-40 min wasted per failed interaction</div>
</div>
</div>
</div>
</div>
...
<div class="mt-4 relative z-10">
<span class="px-6 py-2 bg-gradient-to-r from-cyan-600/80 to-blue-600/80 rounded-full text-white text-lg font-medium shadow-lg shadow-cyan-500/25">Copilot Chat Internals: Debugging AI Interactions</span>
</div>
...
<div class="text-cyan-300 font-bold text-lg">Agent Debug Panel</div>
<div class="text-gray-300 mt-2 text-xs">Real-time event monitoring</div>
</div>
<div class="p-3 bg-gradient-to-br from-blue-900/30 to-blue-800/20 rounded-lg border border-blue-500/30">
<div class="text-blue-300 font-bold text-lg">Complete Visibility</div>
<div class="text-gray-300 mt-2 text-xs">Request, thinking, context, config</div>
</div>
<div class="p-3 bg-gradient-to-br from-indigo-900/30 to-indigo-800/20 rounded-lg border border-indigo-500/30">
<div class="text-indigo-300 font-bold text-lg">Minutes, Not Hours</div>
<div class="text-gray-300 mt-2 text-xs">Systematic troubleshooting</div>
</div>
</div>

<div class="mt-6 text-sm opacity-60 relative z-10">Questions? Open Agent Debug Panel today and see every AI interaction in real-time</div>

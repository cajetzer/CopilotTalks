...
const DARK_THEMES = [
  {
    ...
    pill: 'from-[#43179E]/80 to-[#8534F3]/80 border-[#8534F3]/30 text-white',
    h1: 'from-[#8534F3] via-[#B870FF] to-[#0FBF3E]',
    divider: 'via-[#8534F3]/60',
    arrow: 'text-[#B870FF]',
    subtitle: null,
    cards: [
      { bg: 'bg-[#232925]/60', border: 'border-[#30363d]/60', title: 'text-white', blurb: 'text-[#c9d1d9]' },
      { bg: 'bg-[#232925]/60', border: 'border-[#30363d]/60', title: 'text-white', blurb: 'text-[#c9d1d9]' },
      { bg: 'bg-[#232925]/60', border: 'border-[#30363d]/60', title: 'text-white', blurb: 'text-[#c9d1d9]' },
    ],
  },
  {
    ambientBg: 'from-[#101411] via-[#101411] to-black',
    orb: 'from-[#238636]/15 via-[#43179E]/8 to-transparent',
    pill: 'from-[#238636]/80 to-[#0FBF3E]/80 border-[#0FBF3E]/30 text-white',
    h1: 'from-[#0FBF3E] via-[#238636] to-[#8534F3]',
    divider: 'via-[#0FBF3E]/60',
    arrow: 'text-[#0FBF3E]',
    subtitle: null,
    cards: [
      { bg: 'bg-[#232925]/60', border: 'border-[#30363d]/60', title: 'text-white', blurb: 'text-[#c9d1d9]' },
  ...
  {
    ambientBg: 'from-[#101411] via-[#101411] to-black',
    orb: 'from-[#8534F3]/15 via-[#0FBF3E]/8 to-transparent',
    pill: 'from-[#8534F3]/80 to-[#B870FF]/80 border-[#B870FF]/30 text-white',
    h1: 'from-[#B870FF] via-[#8534F3] to-[#0FBF3E]',
    divider: 'via-[#B870FF]/60',
    arrow: 'text-[#B870FF]',
    subtitle: null,
    cards: [
      { bg: 'bg-[#232925]/60', border: 'border-[#30363d]/60', title: 'text-white', blurb: 'text-[#c9d1d9]' },
  ...
  {
    ambientBg: 'from-[#101411] via-[#101411] to-black',
    orb: 'from-[#0FBF3E]/15 via-[#8534F3]/8 to-transparent',
    pill: 'from-[#238636]/80 to-[#43179E]/80 border-[#238636]/30 text-white',
    h1: 'from-[#0FBF3E] via-[#B870FF] to-[#8534F3]',
    divider: 'via-[#0FBF3E]/60',
    arrow: 'text-[#0FBF3E]',
    subtitle: null,
    cards: [

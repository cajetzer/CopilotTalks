...
const DARK_THEMES = [
  {
    ...
    pill: 'from-[#238636] to-[#238636] border-[#238636]/40 text-white',
    h1: 'from-[#e6edf3] to-[#e6edf3]',
    divider: 'via-[#30363d]',
    arrow: 'text-[#58a6ff]',
    subtitle: null,
    cards: [
      { bg: 'from-[#161b22] to-[#161b22]', border: 'border-[#30363d]', title: 'text-white', blurb: 'text-[#8b949e]' },
      { bg: 'from-[#161b22] to-[#161b22]', border: 'border-[#30363d]', title: 'text-white', blurb: 'text-[#8b949e]' },
      { bg: 'from-[#161b22] to-[#161b22]', border: 'border-[#30363d]', title: 'text-white', blurb: 'text-[#8b949e]' },
    ],
  },
  {
    ambientBg: 'from-[#0d1117] to-[#0d1117]',
    orb: 'from-transparent to-transparent',
    pill: 'from-[#1f6feb] to-[#1f6feb] border-[#1f6feb]/40 text-white',
    h1: 'from-[#e6edf3] to-[#e6edf3]',
    divider: 'via-[#30363d]',
    arrow: 'text-[#3fb950]',
    subtitle: null,
  ...
  },
  {
    ambientBg: 'from-[#0d1117] to-[#0d1117]',
    orb: 'from-transparent to-transparent',
    pill: 'from-[#8957e5] to-[#8957e5] border-[#8957e5]/40 text-white',
    h1: 'from-[#e6edf3] to-[#e6edf3]',
    divider: 'via-[#30363d]',
    arrow: 'text-[#58a6ff]',
    subtitle: null,

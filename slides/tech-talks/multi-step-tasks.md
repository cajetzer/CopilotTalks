...
<h1 class="!text-5xl !font-bold !mt-8 bg-gradient-to-r from-cyan-400 via-blue-400 to-indigo-400 bg-clip-text text-transparent relative z-10">Multi-Step Tasks</h1>
<div class="mt-4 relative z-10">
<span class="px-6 py-2 bg-gradient-to-r from-cyan-600/80 to-blue-600/80 rounded-full text-white text-xl font-medium shadow-lg shadow-cyan-500/25">Context Isolation with Subagents</span>
</div>
<div class="mt-8 text-lg opacity-70 relative z-10">Prevent context pollution with isolated subagent execution</div>
...
<div class="mt-4 relative z-10">
<span class="px-6 py-2 bg-gradient-to-r from-cyan-600/80 to-blue-600/80 rounded-full text-white text-lg font-medium shadow-lg shadow-cyan-500/25">Multi-Step Tasks: Context Isolation with Subagents</span>
</div>
...
<div class="text-cyan-400 font-bold text-lg">🎯 Context Isolation</div>
<div class="opacity-80 text-xs mt-1">Research stays separated from main session</div>
</div>
<div class="p-3 bg-gradient-to-br from-blue-900/30 to-blue-800/20 rounded-lg border border-blue-500/30">
<div class="text-blue-400 font-bold text-lg">⚡ 3–5x Throughput</div>
<div class="opacity-80 text-xs mt-1">Parallel execution multiplies output</div>
</div>
<div class="p-3 bg-gradient-to-br from-indigo-900/30 to-indigo-800/20 rounded-lg border border-indigo-500/30">
<div class="text-indigo-400 font-bold text-lg">🔧 Specialized Agents</div>
<div class="opacity-80 text-xs mt-1">Domain expertise per subtask</div>
</div>
</div>
<div class="mt-6 text-sm opacity-60 relative z-10">Questions? Let's discuss how subagents can transform your complex workflows</div>

...
<div class="font-semibold text-amber-300">Repeated Context</div>
<div class="text-xs opacity-80 mt-1">Developers explain "we use Prisma, not raw SQL" in every chat session</div>
</div>
<div class="p-3 bg-gradient-to-br from-orange-900/30 to-red-900/30 rounded-lg border border-orange-500/30">
<div class="text-xl mb-1">🎯</div>
<div class="font-semibold text-orange-300">Generic Responses</div>
<div class="text-xs opacity-80 mt-1">Copilot suggests textbook patterns instead of your team's architecture</div>
</div>
<div class="p-3 bg-gradient-to-br from-red-900/30 to-purple-900/30 rounded-lg border border-red-500/30">
<div class="text-xl mb-1">📊</div>
<div class="font-semibold text-red-300">Inconsistent Quality</div>
<div class="text-xs opacity-80 mt-1">Different context from each developer = different response quality</div>
</div>
</div>

<div class="mt-6 p-3 bg-gradient-to-r from-cyan-900/40 to-blue-900/40 rounded-lg border border-cyan-500/30">
<div class="text-cyan-300 font-semibold text-sm mb-1">The Real Problem</div>
<div class="text-xs opacity-90">This isn't a limitation of the AI model — it's a <strong>context problem</strong>. Copilot's response quality is directly proportional to how much it knows about your specific codebase.</div>
</div>
</div>
</div>
...
<div class="relative z-10 mb-2">
<div class="text-lg font-bold text-white mb-0.5">Example: /component Generator</div>
<div class="text-xs text-white/50">Standardize React component scaffolding across the team</div>
</div>
<div class="relative z-10 flex-1 min-h-0 flex flex-col gap-2">
...
<div class="relative z-10 flex-1 min-h-0 flex flex-col gap-2">
<div class="grid grid-cols-2 gap-2">
<div class="flex flex-col bg-gray-950/80 rounded-xl border border-purple-500/30 p-3 max-h-60 overflow-y-auto">
...
<div class="text-white ml-5">prompt: Implement the plan.</div>
<div class="text-blue-400">---</div>
</div>
<div class="text-xs text-gray-300 flex-1 space-y-1">
<div class="font-semibold text-white"># Planning Agent</div>
<div>You are a senior software architect.</div>
<div class="mt-1 font-semibold text-white">## Your Process</div>
<div>• Research the codebase using search</div>
<div>• Identify affected files and components</div>
<div>• Generate step-by-step plan</div>
<div class="mt-1 font-semibold text-white">## Rules</div>
<div>• <strong>NEVER modify files</strong> — you are read-only</div>
</div>
</div>

<div class="flex flex-col gap-2">
<div class="p-3 bg-gradient-to-br from-purple-900/40 to-pink-900/40 rounded-xl border border-purple-500/30">
<div class="text-xs font-semibold text-purple-300 mb-2">🔒 Why Constrain Tools?</div>
<div class="text-xs opacity-80 space-y-1">
<div>• Planner: read-only prevents accidental edits</div>
<div>• Security reviewer: search but no terminal</div>
<div>• DB admin: terminal + SQL but no frontend code</div>
</div>
</div>

<div class="p-3 bg-gradient-to-br from-pink-900/40 to-rose-900/40 rounded-xl border border-pink-500/30">
<div class="text-xs font-semibold text-pink-300 mb-2">🤝 Handoff Workflow</div>
<div class="text-xs opacity-80 space-y-1">
<div><strong>Step 1:</strong> Planner researches and creates plan</div>
<div><strong>Step 2:</strong> "Start Implementation" button appears</div>
<div><strong>Step 3:</strong> Switches to agent with plan as context</div>
<div><strong>Step 4:</strong> Optional "Review Code" handoff to security agent</div>
</div>
</div>
</div>
</div>
...
<div class="p-2 bg-gradient-to-r from-emerald-900/40 to-cyan-900/40 rounded-lg border border-emerald-500/30">
<div class="text-xs"><strong>Real Impact:</strong> DB admin agent = zero production migration rollbacks in 6 months, 60% faster schema review process.</div>
</div>
</div>
</div>
